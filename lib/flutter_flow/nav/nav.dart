...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => AuthenticationScreenWidget(
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'DashboardScreen')
              : const DashboardScreenWidget(),
        ),
        FFRoute(
          name: 'CodeScreen',
          path: '/codeScreen',
          builder: (context, params) => const CodeScreenWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => const PhoneSignInScreenWidget(),
        ),
        FFRoute(
          name: 'Profile',
          path: '/profile',
        ...
        FFRoute(
          ...
          path: '/petProfile',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'PetProfile')
