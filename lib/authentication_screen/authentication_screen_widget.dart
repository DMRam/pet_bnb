...
class AuthenticationScreenWidget extends StatefulWidget {
  ...
  @override
  _AuthenticationScreenWidgetState createState() =>
      _AuthenticationScreenWidgetState();
}

class _AuthenticationScreenWidgetState extends State<AuthenticationScreenWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthenticationScreenModel());
        ...
        body: Container(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              fit: BoxFit.cover,
              image: Image.network(
                'https://media.istockphoto.com/id/610851714/vector/pets-collection.jpg?s=612x612&w=0&k=20&c=bxlsQ1nZZvPLsNhWpmlQYR1VLlY-2mh2WB7sb2gLL94=',
              ).image,
            ),
          ),
          child: Container(
