...
import 'upcoming_guests_model.dart';
export 'upcoming_guests_model.dart';

class UpcomingGuestsWidget extends StatefulWidget {
  const UpcomingGuestsWidget({super.key});

  @override
  _UpcomingGuestsWidgetState createState() => _UpcomingGuestsWidgetState();
}

class _UpcomingGuestsWidgetState extends State<UpcomingGuestsWidget> {
  late UpcomingGuestsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpcomingGuestsModel());
