...
import 'host_pet_details_model.dart';
export 'host_pet_details_model.dart';

class HostPetDetailsWidget extends StatefulWidget {
  const HostPetDetailsWidget({super.key});

  @override
  _HostPetDetailsWidgetState createState() => _HostPetDetailsWidgetState();
}

class _HostPetDetailsWidgetState extends State<HostPetDetailsWidget> {
  late HostPetDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HostPetDetailsModel());
            ...
            children: [
              Padding(
                ...
                child: ClipRRect(
                  ...
                  child: Image.network(
                    'https://www.acws.cl/wp-content/uploads/2017/11/todolodehuron-1-2000x1000.jpg',
