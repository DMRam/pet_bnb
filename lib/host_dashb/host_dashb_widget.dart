                              ...
                              child: StreamBuilder<List<BookingPetbnbRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<BookingPetbnbRecord>
                                      listViewBookingPetbnbRecordList =
                                      snapshot.data!;
                                  return ListView.builder(
                                    padding: EdgeInsets.zero,
                                    primary: false,
                                    ...
                                    itemCount:
                                        listViewBookingPetbnbRecordList.length,
                                    itemBuilder: (context, listViewIndex) {
                                                          ...
                                                          padding:
                                                              const EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            '> Owner\'s name: ${listViewBookingPetbnbRecord.ownerName}',
                                                          ...
                                                          padding:
                                                              const EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            '> Pet type: ${listViewBookingPetbnbRecord.petType}',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .labelMedium,
                                                          ),
